...
class MessageSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Message::create([
            ...
            'response' => 'If you want to log in you have to insert the character # followed from the word login then email then password. eg: #login jorge@flores.com 123456',
        ]);
        Message::create([
        ...
        Message::create([
            ...
            'response' => 'To sign up you have to insert the character # followed from the word signup then email then password then your inicial amount then your currency. eg: #signup jorge@flores.com 123456 30 USD',
        ]);
        Message::create([
